...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue was adding the new person to the beginging index of the queue, creating a last in first out which is the opposite of what a queue should do. Changed Insert(0, person) to Add(person)
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: GetNextPerson needed an additional if statement to account for <= 0 turns to make as infinite. Otherwise it would not requeue the person. 
